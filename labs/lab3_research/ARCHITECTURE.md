...
For this lab: an orchestrator owns the budget, a researcher calls the tool boundary, a writer assembles the brief, and a judge checks grounding and style without a model.
