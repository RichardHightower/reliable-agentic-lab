...
doc_type: roadmap
truth_state: current
source_hash: eb4ec5b9
generated_at: 2026-09-07T17:49:09Z
git_hash: "cb88cbc"
---
...
|---|---|---|---|---|---|
| 01M1YFSX | sol2 0/9: publish Sol-2-Implementer-Review on the wiki | story | P1 | todo | — |
| 01M1YFSX | sol2 0/9: publish the review page and link it from Home, Lab-2, and Sidebar | task | P1 | todo | — |
| 01M1YFSX | sol2 1/9: receipt.check tests in both ports, then wire or strike the push gate | story | P1 | todo | — |
| 01M1YFSX | sol2 1/9: tests for receipt.check in both ports | task | P1 | todo | — |
| 01M1YFSY | sol2 1/9: wire the push gate, or strike the slides | task | P1 | todo | — |
| 01M1YFSY | sol2 2/9: the judge sees the diff, and offline can say not done | story | P1 | todo | — |
| 01M1YFSY | sol2 2/9: put the diff and the plan summary in the judge prompt | task | P1 | todo | — |
| 01M1YFSY | sol2 2/9: a fixture judge can say no | task | P1 | todo | — |
| 01M1YFSY | sol2 3/9: run the loop in an isolated git worktree | story | P1 | todo | — |
| 01M1YFSY | sol2 3/9: isolated git worktree as the repo the loop mutates | task | P1 | todo | — |
| 01M1YFSY | sol2 4/9: durable state, resume, and CI exit codes | story | P1 | todo | — |
| 01M1YFSY | sol2 4/9: write .harness/state.json next to the receipt | task | P1 | todo | — |
| 01M1YFSY | sol2 4/9: --resume continues from state | task | P1 | todo | — |
| 01M1YFSY | sol2 4/9: process exits 0 pass, 2 escalate, 1 crash | task | P1 | todo | — |
| 01M1YFSY | sol2 5/9: the test implementer reads the plan and may retry | story | P1 | todo | — |
| 01M1YFSY | sol2 5/9: test-implementer prompt includes the plan | task | P1 | todo | — |
| 01M1YFSY | sol2 5/9: test phase may retry inside the budget | task | P1 | todo | — |
| 01M1YFSY | sol2 6/9: planner-as-subagent behind a flag, schema unchanged | story | P1 | todo | — |
| 01M1YFSY | sol2 6/9: --planner derived|sdk|deep, default derived | task | P1 | todo | — |
| 01M1YFSY | sol2 7/9: Deep Agents SPEC and live fence probe, copied not imported | story | P1 | todo | — |
| 01M1YFSY | sol2 7/9: DA SPEC names the fence at SDK depth | task | P1 | todo | — |
| 01M1YFSY | sol2 7/9: Layer-3 fence probe that fails if the mock is lying | task | P1 | todo | — |
| 01M1YFSY | sol2 8/9: no live backend holds Bash | story | P1 | todo | — |
| 01M1YFSZ | sol2 8/9: copy SDK OVERRIDES into DA roleplan.py | task | P1 | todo | — |
| 01M1YFSZ | sol2 8/9: fence or drop CliBackend for the implementer ports | task | P1 | todo | — |
| 01M1YFSZ | sol2 9/9: docs, traces, and parity tests | story | P1 | todo | 01M1YFSX, 01M1YFSY, 01M1YFSY, 01M1YFSY, 01M1YFSY, 01M1YFSY, 01M1YFSY, 01M1YFSY |
| 01M1YFSZ | sol2 9/9: docs match the code that shipped | task | P1 | todo | — |
| 01M1YFSZ | sol2 9/9: parity tests across both ports | task | P1 | todo | — |
| 01M1YFSZ | sol2 9/9: optional live T001 traces | task | P1 | todo | — |
