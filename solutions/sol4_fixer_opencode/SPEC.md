# Spec. Lab 4. Broken PR Fixer, unattended, with OpenCode
...
drives OpenCode is `labs/lab4_fixer/prompts/opencode.md`.
...
7. Compare your answer against this folder.
   ...
   ```bash
   diff loop.py ../../solutions/sol4_fixer_opencode/loop.py
   ```
...
```bash
cd solutions/sol4_fixer_opencode
task test
```
