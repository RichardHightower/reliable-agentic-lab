# Spec. Lab 3. Research Assistant over MCP, with OpenCode
...
drives OpenCode is `labs/lab3_research/prompts/opencode.md`.
...
2. Drive OpenCode with the lab's prompt, or fill `loop.py` by hand.
...
7. Compare your answer against this folder.
   ...
   ```bash
   diff loop.py ../../solutions/sol3_research_opencode/loop.py
   ```
...
```bash
cd solutions/sol3_research_opencode
task test
```
