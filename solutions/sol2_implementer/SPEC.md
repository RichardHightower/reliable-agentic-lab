# Spec. Lab 2. Ticket Implementer and the harness, with Claude Code
...
drives Claude Code is `labs/lab2_implementer/prompts/claude-code.md`.
...
2. Drive Claude Code with the lab's prompt, or fill `harness.py` by hand.
...
8. Compare your answer against this folder.
   ...
   ```bash
   diff harness.py ../../solutions/sol2_implementer/harness.py
   ```
