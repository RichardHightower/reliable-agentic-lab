...
class Ticket:
    ...
    @property
    def ready(self) -> bool:
        """Ready is a state, not a side effect of having bullets.

        A draft that already lists criteria is still a draft. The enhancer
        flips `state: ready`. Treating criteria as enough fails open.
        """
