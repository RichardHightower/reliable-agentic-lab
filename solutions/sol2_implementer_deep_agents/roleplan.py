...
#
# No role in the implementer cast holds `Bash`. A code implementer that can run
# `sed -i` on a failing test does not need `Write` to edit that test into
# passing, and a shell is a wider hole than any of the three write tools it
# would replace.
