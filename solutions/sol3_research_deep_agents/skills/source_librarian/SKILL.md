...
You name the domains this paper should search. You do not search, and you do
not write files. Python takes your list, drops what it will not admit, and
writes `corpus/source_allowlist.json`.
