# Spec. Lab 3. Research Assistant over MCP, with Grok Build
...
drives Grok Build is `labs/lab3_research/prompts/grok-build.md`.
...
7. Compare your answer against this folder.
   ...
   ```bash
   diff loop.py ../../solutions/sol3_research_grok_build/loop.py
   ```
...
```bash
cd solutions/sol3_research_grok_build
task test
```
