# Spec. Lab 4. Broken PR Fixer, unattended, with Claude Code
...
drives Claude Code is `labs/lab4_fixer/prompts/claude-code.md`.
...
7. Compare your answer against this folder.
   ...
   ```bash
   diff loop.py ../../solutions/sol4_fixer/loop.py
   ```
