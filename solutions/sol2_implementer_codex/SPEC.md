# Spec. Lab 2. Ticket Implementer and the harness, with Codex
...
drives Codex is `labs/lab2_implementer/prompts/codex.md`.
...
2. Drive Codex with the lab's prompt, or fill `harness.py` by hand.
...
8. Compare your answer against this folder.
   ...
   ```bash
   diff harness.py ../../solutions/sol2_implementer_codex/harness.py
   ```
...
```bash
cd solutions/sol2_implementer_codex
task test
```
