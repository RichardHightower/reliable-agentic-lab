# Spec. Lab 4. Broken PR Fixer, unattended, with Grok Build
...
drives Grok Build is `labs/lab4_fixer/prompts/grok-build.md`.
...
7. Compare your answer against this folder.
   ...
   ```bash
   diff loop.py ../../solutions/sol4_fixer_grok_build/loop.py
   ```
...
```bash
cd solutions/sol4_fixer_grok_build
task test
```
