# Spec. Lab 3. Research Assistant over MCP, with Codex
...
drives Codex is `labs/lab3_research/prompts/codex.md`.
...
7. Compare your answer against this folder.
   ...
   ```bash
   diff loop.py ../../solutions/sol3_research_codex/loop.py
   ```
...
```bash
cd solutions/sol3_research_codex
task test
```
