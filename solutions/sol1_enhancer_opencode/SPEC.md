# Spec. Lab 1. Ticket Enhancer, with OpenCode
...
drives OpenCode is `labs/lab1_enhancer/prompts/opencode.md`.
...
7. Compare your answer against this folder.
   ...
   ```bash
   diff loop.py ../../solutions/sol1_enhancer_opencode/loop.py
   ```
