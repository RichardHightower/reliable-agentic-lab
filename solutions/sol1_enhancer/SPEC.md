# Spec. Lab 1. Ticket Enhancer, with Claude Code
...
drives Claude Code is `labs/lab1_enhancer/prompts/claude-code.md`.
...
7. Compare your answer against this folder.
   ...
   ```bash
   diff loop.py ../../solutions/sol1_enhancer/loop.py
   ```
