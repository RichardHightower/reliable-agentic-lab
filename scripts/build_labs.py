...
LABS_SPEC = [
    # lab1_enhancer / sol1_enhancer* are intentionally not generated here.
    # Lab 1 was hand-redefined as a Claude Code plugin (see solutions/sol1_enhancer/
    # and labs/lab1_enhancer/), and this generator's Python fill-in template no
    # longer matches it. Re-add a Lab(...) entry only if lab 1 goes back to being
    # a generated Python stub.
    Lab(
